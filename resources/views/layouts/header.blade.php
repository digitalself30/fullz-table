    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand" href="{{url('/' . $page='index')}}">
                ...
                <img src="{{URL::asset('assets/images/brand/logo.png')}}" class="header-brand-img dark-logo" alt="Admintro logo">
                <img src="{{URL::asset('assets/images/brand/favicon.png')}}" class="header-brand-img darkmobile-logo" alt="Admintro logo">
            </a>
...
{{--                        @endif--}}
                        <a class="dropdown-item d-flex">
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <button type="submit" class="px-0" style="background: none;border: none;color: #d5dae2;">Logout</button>
                            </form>
                        </a>
                    </div>
                </div>
