    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand" href="{{url('/' . $page='index')}}">
                <img src="{{URL::asset('assets/images/img/logo.png')}}" class="header-brand-img desktop-lgo" alt="Fullz Store Logo">
                <img src="{{URL::asset('assets/images/img/favicon.png')}}" class="header-brand-img mobile-logo" alt="Fullz Store Logo">
                <img src="{{URL::asset('assets/images/img/logo.png')}}" class="header-brand-img dark-logo" alt="Fullz Store Logo">
                <img src="{{URL::asset('assets/images/img/favicon.png')}}" class="header-brand-img darkmobile-logo" alt="Fullz Store Logo">
            </a>
            ...
            <div class="d-flex order-lg-2 ml-auto">
                ...
                @if(Auth::user()->user_type == 2 )
                        <div class="dropdown header-message" style="margin-top: 7px; margin-right: 5px">
                        <a class="btn btn-success" href="{{route('add.funds')}}">
                            <svg class="header-icon" style="fill:#fdf3f3" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M11.17 8l-.58-.59L9.17 6H4v12h16V8h-8z" opacity=".3"></path><path d="M20 6h-8l-2-2H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm0 12H4V6h5.17l1.41 1.41.59.59H20v10z"></path></svg>
                            Add Funds
                        </a>
                    </div>
                    @php
                    ...
                    <div class="dropdown header-message" style="margin-top: 7px">
                        <a class="btn btn-success">
                            <svg class="header-icon" style="fill:#fdf3f3" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M11.17 8l-.58-.59L9.17 6H4v12h16V8h-8z" opacity=".3"></path><path d="M20 6h-8l-2-2H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm0 12H4V6h5.17l1.41 1.41.59.59H20v10z"></path></svg>
                            Balance: ${{$wb->balance ?? 0.00}}
                        </a>
                    </div>
                @endif
                @if(Auth::user()->user_type == 2 )
                <div class="dropdown header-message">
                    <a class="nav-link icon cart-item-container"  href="{{route('cart')}}">
                        <svg class="header-icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M15.55 11l2.76-5H6.16l2.37 5z" opacity=".3"></path><path d="M15.55 13c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.37-.66-.11-1.48-.87-1.48H5.21l-.94-2H1v2h2l3.6 7.59-1.35 2.44C4.52 15.37 5.48 17 7 17h12v-2H7l1.1-2h7.45zM6.16 6h12.15l-2.76 5H8.53L6.16 6zM7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zm10 0c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2z"></path></svg>
                        @if(Cart::count() > 0)
                            <span class="badge badge-success side-badge cart-item">{{Cart::count()}}</span>
                        @endif
                    </a>
                </div>
                @endif
                ...
                @php
                    if(Auth::user()->user_type == 1){
                        $notifications = \Spatie\Activitylog\Models\Activity::with('causer')->latest()->take(5)->get();
                    }
                    else{
                        $notifications = \Spatie\Activitylog\Models\Activity::with('causer')->where('causer_id', Auth::id())->latest()->take(5)->get();
                    }
                @endphp
                ...
                <div class="dropdown profile-dropdown">
                    <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                        <span>
                            <img src="{{URL::asset('assets/images/users/profile2.png')}}" alt="img" class="avatar avatar-md brround">
                        </span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                        <div class="text-center">
                            @if(Auth::check())
                                <a href="{{route('user.profile')}}" class="dropdown-item text-center user pb-0 font-weight-bold">{{Auth::user()->name}}</a>
                        ...
                        <a class="dropdown-item d-flex">
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <button type="submit" class="px-0" style="background: none;border: none;">Logout</button>
                            </form>
                        </a>
                    </div>
                </div>
