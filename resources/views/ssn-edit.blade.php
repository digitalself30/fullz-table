...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">SSN Edit</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('home')}}"><i class="fe fe-layout mr-2 fs-14"></i>Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="#">SSN Edit</a></li>
            </ol>
        </div>
    </div>
    <!--End Page header-->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">SSN Edit</div>
                </div>
                <div class="card-body">
                    <form id="myForm" action="{{route('update.ssn.table')}}" method="POST">
                        @csrf
                        <input type="hidden" name="type" value="ssn">
                    <div class="card-body">
