...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden dash1-card border-0">
                <div class="card-body">
                    ...
                    <h2 class="mb-1 number-font">{{$wallet->balance ?? 0.00}}$</h2>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden dash1-card border-0">
                <div class="card-body">
                    <p class=" mb-1 ">Purchased Item</p>
                    <h2 class="mb-1 number-font">{{$purchased_item ?? 0}}</h2>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden dash1-card border-0">
                <div class="card-body">
                    <p class=" mb-1 ">This Month Spent</p>
                    <h2 class="mb-1 number-font">${{$this_month_spent ?? 0.00}}</h2>
                    <span class="ratio bg-success">100%</span>
                </div>
                <div id="spark3"></div>
            </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden dash1-card border-0">
                <div class="card-body">
                    ...
                    <h2 class="mb-1 number-font">${{$total_spent ?? 0.00}}</h2>
                    <span class="ratio bg-success">100%</span>
                </div>
                <div id="spark4"></div>
            </div>
                            ...
                            @if(count($activity_logs) > 0)
                                @foreach($activity_logs AS $activity_log)
                                    ...
                                    <li class="mt-0">
                                        ...
                                        <p class="text-muted fs-12">{{$activity_log->description}}</p>
                                    </li>
                                @endforeach
                            @endif
                        </ul>
